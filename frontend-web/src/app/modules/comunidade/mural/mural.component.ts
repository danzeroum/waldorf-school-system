...
export class MuralComponent implements OnInit {
  ...
  readonly tipos: TipoAviso[] = ['GERAL', 'TURMA', 'URGENTE', 'EVENTO', 'CARDAPIO'];
  ...
  get podePublicar(): boolean {
    return this.authService.temPerfil('SECRETARIA') || this.authService.temPerfil('DIRETOR') || this.authService.temPerfil('PROFESSOR');
  }
  ...
  private mockAvisos(): Aviso[] {
    return [
      ...
      { id: 3, titulo: 'Festival de Artes — Abril', conteudo: 'O Festival Anual de Artes acontecerá nos dias 18 e 19 de abril. Aguardem programação completa em breve.', tipo: 'EVENTO', autorNome: 'Direção', fixado: false, dataPublicacao: '2026-03-11' },
    ];
  }
}
